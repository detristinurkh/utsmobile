...
import 'package:uts_detristi/item_detail.dart';
import 'package:uts_detristi/cari.dart';
import 'package:uts_detristi/splash_interval.dart';
import 'package:uts_detristi/product.dart';
...
class Dashboard extends StatelessWidget {
  ...
  static final ProductModel _produkList = ProductModel();

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => SearchInterval(_produkList.listProduct),
      child: Scaffold(
        appBar: AppBar(
              ...
              builder: (context, searchProvider, child) {
                ...
                return ListView.builder(
                  ...
                  itemCount: searchProvider.cari
                      ...
                      : _produkList.listProduct.length,
                  itemBuilder: (_, index) {
                    return Container(
